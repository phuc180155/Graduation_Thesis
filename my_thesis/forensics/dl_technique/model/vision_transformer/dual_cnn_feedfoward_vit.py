...
class FeedforwardNeuralNetModel(nn.Module):
    def __init__(self, input_dim=88, hidden_dim=256, output_dim=1024):
...
class DualCNNFeedForwardViT(nn.Module):
    def __init__(self, \
        ...
        self.freq_extractor = FeedforwardNeuralNetModel(input_dim=input_freq_dim, hidden_dim=hidden_freq_dim, output_dim=dim)
        ############################# PATCH CONFIG ################################

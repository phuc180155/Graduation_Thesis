...
class PairwiseDualEfficientViT(nn.Module):
    def __init__(self, \
        ...
        super(PairwiseDualEfficientViT, self).__init__()
...
if __name__ == '__main__':
    ...
    model_ = PairwiseDualEfficientViT(  image_size=128, num_classes=1, dim=1024,\
                                depth=6, heads=8, mlp_dim=2048,\
                                dim_head=64, dropout=0.15, emb_dropout=0.15,\

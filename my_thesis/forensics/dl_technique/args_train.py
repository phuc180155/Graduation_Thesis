...
def parse_args():
    ...
    parser_kfold_dual_dab_cnn_multivit.add_argument("--gammaagg_reso", type=str, default='-1_-1', help="")
    ...
    parser_kfold_pairwise_dual_dab_cnn_multivit.add_argument("--gammaagg_reso", type=str, default='-1_-1', help="")
